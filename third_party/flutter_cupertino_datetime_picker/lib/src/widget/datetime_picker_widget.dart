...
class _DateTimePickerWidgetState extends State<DateTimePickerWidget> {
  ...
  _DateTimePickerWidgetState(
    ...
    this._currMinute = min(
      max(_minuteRange.first, _currMinute),
      _minuteRange.last,
    );

    // limit the range of second
    this._secondRange = _calcSecondRange();
    this._currSecond = min(
      max(_secondRange.first, _currSecond),
      _secondRange.last,
    );
  ...
  Widget _renderDatePickerColumnComponent({
    ...
    Widget columnWidget = Container(
      ...
      child: CupertinoPicker.builder(
        ...
        selectionOverlay:
            widget.pickerTheme.selectionOverlay ??
            Container(
  ...
  void _changeTimeRange() {
    ...
    bool hourRangeChanged =
        _hourRange.first != hourRange.first ||
    ...
    bool minuteRangeChanged =
        _minuteRange.first != minuteRange.first ||
    ...
    bool secondRangeChanged =
        _secondRange.first != secondRange.first ||
